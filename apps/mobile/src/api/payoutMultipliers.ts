...
// primeras/ultimas3/ultimas2: bonos exclusivos de los billetes de 4 cifras completas (primeras 3
// cifras / últimas 3 cifras / últimas 2 cifras).
export type MatchType = 'ultimas' | 'primeras' | 'ultimas3' | 'ultimas2';
